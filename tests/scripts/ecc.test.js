  ...
  const tests = [
    ...
    [
      ...
      () => {
        ...
        fs.writeFileSync(path.join(sessionsDir, '2026-03-13-a1b2c3d4-session.tmp'), '# ECC Session\n\n**Branch:** feat/ecc-cli\n');
    ...
    [
      ...
      () => {
        ...
        fs.writeFileSync(path.join(projectRoot, 'package.json'), JSON.stringify({ dependencies: { leftpad: '1.0.0' } }, null, 2));
