...
function runTests() {
  ...
  if (test('syncs tracked catalog docs in write mode without rewriting unrelated tables', () => {
    ...
    assert.ok(readme.includes('| **Agents** | 1 | Shared (AGENTS.md) | 12 |'), 'Should sync README parity table');
    ...
    assert.ok(zhDocsReadme.includes('| **智能体** | 1 | 共享 (AGENTS.md) | 12 |'), 'Should sync docs/zh-CN/README parity table');
