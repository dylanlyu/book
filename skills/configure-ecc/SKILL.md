---
name: configure-ecc
description: Guide ECC installation, update, or reconfiguration from inside Claude Code or Codex while respecting each harness's real plugin, scope, and hook capabilities.
metadata:
  origin: ECC
---
