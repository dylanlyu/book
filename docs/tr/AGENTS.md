...
Bu, yazılım geliştirme için 68 özel agent, 283 skill, 94 command ve otomatik hook iş akışları sağlayan **üretime hazır bir AI kodlama eklentisidir**.
...
skills/          — 283 iş akışı skillleri ve alan bilgisi
