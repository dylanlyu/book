...
Usage:
  ecc install --guided
  ecc install --guided --harness claude --harness codex [options]
...
Options:
  --harness <id[,id...]>  Repeatable; accepts Claude, Codex, or all
...
async function askHarnesses(terminal, output) {
  ...
  while (true) {
    ...
    if (answer.length > 1024) {
      output.write('Please choose Claude, Codex, or all.\n');
      continue;
    }
    try {
