...
const TARGETS = ['README.md', 'skills', 'commands', 'agents', 'docs'];

const EXEMPT_PREFIXES = ['docs/fixes/'];

const PLACEHOLDER_USERNAMES = new Set(['example', 'me', 'user', 'username', 'you', 'yourname', 'yourusername', 'your-username']);
